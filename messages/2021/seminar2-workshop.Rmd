...
- Breakout rooms - each person will have ~3 minutes to present their ideas to the group and get feedback from the chair - ~45 min

- Discussion of break out rooms ~15 min

- Live demo of using RMarkdown to write a coursework topic and technical questions - see https://bookdown.org/yihui/rmarkdown-cookbook/ - 15 min