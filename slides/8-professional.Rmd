...
## '1 pager' document on plans

- Submit a .zip file containing an .Rmd file and a 1 page pdf
...
browseURL("~/hd/backups/onedrive-backups/onedrive-big-mirror/career/modules/tds/2020-marks/")
...
See `stats19-example.zip` for an an example of a coursework submission
