...
-   to ensure scientific reproducibility and transparency in the
...
-   Gain proficiency in command-line tools (primarily R) for handling
...
-   Understand 'big' data sources, the need for them, and how they
    differ from classical data sources
-   Learn how to use these skills in the wider context of a dynamic team
    environment, including project set-up (e.g. deciding between cloud
    services and local computing power) and problem definition; team
    workflow; sourcing and interrogating data; applying statistical
    methods; visualising data and communicating the results (e.g. via
...
-   Route assignment with remote routing services and locally installed
    software
-   Data visualization
-   Machine learning
...
Students are expected to spend their study time on background reading
for lectures, preparatory work for workshops and assessed
coursework.<br>Unsupervised teamwork practical sessions will be arranged
each week.<br>
</p>
<h3>
...
<p>
20% of the mark for the assessment of the portfolio will be determined
as an initial assessment after week 5. Feedback will be provided. The
remaining 80% will be awarded in respect of the final submitted
portfolio.
...
It is also recommended that you install GitHub Deskto (or command line
...
doi:[10.1016/j.retrec.2016.05.004](https://doi.org/10.1016/j.retrec.2016.05.004).
