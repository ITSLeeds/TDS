...
**Distinction:** The report makes use of a complex (with many columns and rows) and/or multiple input datasets, efficiently importing them and adding value by...


...


    **Visualization and aesthetics: 20%**

1. Creation of figures that are readable and well-described (e.g. with captions and description)
1. High quality, attractive or advanced techniques (e.g. interactive maps, facets or other advanced techniques)
...
1. The report is aesthetically pleasing, with appropriate figure captions, cross-references and a consistent style

**Distinction:** 

    **Code quality, efficiency and reproducibility: 20%**

1. Code quality, including using consistent style, appropriate packages, and clear comments
...
1. Code availability and sharing, e.g. code is shared on GitHub or another platform
...
1. Discuss alternative topics and methods/approaches considered and justify the topic and make specific recommendations for further research or policies that are supported by the data analysis undertaken, and explain the potential impacts of the work
1. Discussion of the strengths and weaknesses of the analysis
1. The contents of the report fit together logically and support the aims of the report and seek to answer the research question(s)
