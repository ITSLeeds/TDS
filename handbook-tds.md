...
This module provides a broad outline of ………. Over the course of the year
we will become more familiar with a broad range of processes and
environments, …………… We will examine ……………………. Lectures will familiarise
you with key concepts and topics; you will get more chance to interact
with the subject material in workshops; while practicals and field days
will provide you with hands-on experience. \[Edit as appropriate to
include seminars, tutorials etc.\]
...
catalogue. Please click on the link below for either postgraduate or
undergraduate catalogue: Postgraduate Module Catalogue Undergraduate
Module Catalogue

Links with other modules This module builds on material and ideas
presented in TRANXXXX. You will find points of intersection with a
number of level 2 modules; …. The module feeds into several level 3
modules, including… \[Edit as appropriate, or delete if not relevant.\]

Module Teaching Team

The module convenor/leader/manager \[delete as appropriate\] is ………
Please see table below for the contact information of each member of the
module team:

Staff Name Room Location Email Address Contact Hours during termtime*
Staff Name Room Location Email Address Contact Hours during termtime*

\[\*Staff should consider whether it is useful to publicise regular
office hours. You may prefer to have an ‘open door’ policy.\] Please
email with any questions, and feel free to ask any member of the
teaching team for help or clarification after the lectures or during
their office hours.

On line information All teaching materials and resources are accessed
through Minerva. This may include PowerPoint slides, hand outs, web
links to reading lists, audio or video recordings of lectures, excerpts
from external audio or video sources, discussion forums etc.

All past exams for modules are available online in the Examinations
Section of the Examinations and Assessment area on the website.

Assessment(s) & Dates \[Please make sure that the information in this
section is consistent with the module’s entry in the module catalogue.\]
Assessment for this module takes the form of: \[Please list all
components including any exam or pass to progress elements – this must
be identical to the list on the module catalogue. The deadline for
submitting work is 2pm on the specified day. Module Leaders should not
set deadlines on Fridays, or on the last day of term.\] 1) … – max word
length … words; deadline, week, date and time; proportion of the total
assessment and any other relevant information. 2) Exam, exam period it
will take place, duration, and percentage of total assessment NB The
deadline for submitting work is 2pm on the day of the deadline, unless
otherwise stated.

Assessment Return Date to students As stated in the Code of Practice on
Assessment, coursework will normally be returned in no more than 15
working days. We will endeavour to avoid delays but will inform you if
any should arise.  
\[Please note that the SES office will require two working days to sort
and turn around any coursework handed back to them, so you will need to
consider this when setting your return date for coursework to students.
If there are multiple assessments, make sure that there is AT LEAST one
week between return of the coursework and student submission of the
next.\]

Re-sit Requirements If you fail this module, you can register to re-sit
the failed components at the next available opportunity. \[Staff to
insert here information on what the re-sit consists of. It could be the
same as the original assessment, in which case this can simply be
stated. NB You do not need to provide the detail, simply state the
assessment format; e.g. single exam, an assignment or combination
thereof.\]

Covid-19 Information For queries related to the University’s policy on
Covid-19 please visit <https://coronavirus.leeds.ac.uk/> and
<https://coronavirus.leeds.ac.uk/supporting-students-and-staff/> for the
most up to date information and advise on how we can support you.
...
shown in the Figure below. Data science skills and dedicated data
scientists have a huge amount to offer transport planners, especially
when considering large transport systems (Graells-Garrido, Peña-Araya,
and Bravo 2020) and the urgent problem of rapid decarbonisation to
tackle the climate crises, which cannot be solved using traditional
methods alone (Lovelace, Parkin, and Cohen 2020).
...
questions. The course objectives are to:
...
Robin is Associate Professor of Transport Data Science Institute for
Transport Studies, University of Leeds. He researches scalable, open
source and interactive transport models. He has a degree in Geography
from the University of Bristol, an MSc in Environmental Science and
Management from the University of York and a PhD from the university of
Sheffield. Robin is also a programmer and has contributed many software
tools and resources to the data science and transport communities. For
more information, see my page on the University of Leeds’ website:
<https://environment.leeds.ac.uk/transport/staff/953/dr-robin-lovelace>

# 3 Pre-requisites

You should use the VLE site and <https://github.com/ITSLeeds/TDS> to
find web links to content. These materials may be updated throughout the
module so please check you have the latest versions.
...
tools such as SUMO but these are not essential.
...
Although individual reports will be submitted, you are encouraged to
collaborate throughout the course. Group projects that are based on a
single topic or dataset, but with each member focussing on a different
aspect for the report, are allowed.
...
Questions are encouraged so please just ask if you have any doubts. It
...
4.  mention who you have asked and paste what you have found on the net
    in your email to me to show that you have done 1 and 2.

# 6 Credit assignment

This is a 15 credit module.

## 6.1 Examination method

This is not a traditional lecture course. The module is 100% examined by
a report on a single team project. The coursework can be a **maximum**
of **10 pages** long and **3000 words** in total, excluding references.
Quality is valued over quantity.

The coursework is a ‘portfolio’ of work that you will build-up over the
course of the project. **It will be submitted on the Friday of week
24**.
...
# 7 ITS/Leeds standard processes
...
I personally recommend using Zotero, a free and open source reference
management system. Used in sync with writing software such as RStudio
with the **citr** package installed can make referencing fun!
...
Only your final report is assessed formally as part of your MSc grade.
