...
# Upload exercises
file.rename("pracitals/2day.pdf", ".")
piggyback::pb_upload("2day.pdf")
```
...
curl -i https://git.io -F "url=https://github.com/ITSLeeds/TDS/blob/master/courses/analysis-4hr.md" -F "code=tds4hr"
```
...
1. Use the function `source()` to run all the code in a script e.g. `source("TDS-lesson-1.R")` (but don't create an infinite loop!)
