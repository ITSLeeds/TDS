...
Exercies Reporduce the Isle of Wight flow data `d_iow_origins` that you used in the Data Cleaning Practical
...
Now we need to add coordinates to these flows. Lets use the population weighted centroids in the `pct` package.
...
We can extract the coordiantes out of a geometry column using `st_coordinates`
