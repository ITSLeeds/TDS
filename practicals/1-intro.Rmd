...
- Run the code in the [demos/demo-quarto-document.qmd](https://github.com/ITSLeeds/TDS/blob/master/demos/demo-quarto-document.qmd) script
...
Work through all of the code in the RRSRR tutorial, focussing on the parts that you think will be most useful for your coursework.
