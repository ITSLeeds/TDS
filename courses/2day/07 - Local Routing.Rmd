...
Now we will get some data from the [PCT](http://www.pct.bike). The `get_pct_lines` function returns the desier lines from the PCT.
...
Now we will take the top 3 desier lines and route them though Transport API. First we will subets the top lines and creat from an two coordiantes
...
We will repeate the analysis using a local routing tool. This turorial is based on the [packgee vignette](https://itsleeds.github.io/opentripplanner/articles/opentripplanner.html)
