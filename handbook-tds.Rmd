...
bibliography: tds-handbook.bib
---

```{r, include=FALSE}
rbbt::bbt_update_bib("handbook-tds.Rmd", "tds-handbook.bib")
...
- The [transport chapter](http://geocompr.robinlovelace.net/transport.html) of Geocompution with R (available free [online](http://geocompr.robinlovelace.net/)) [@lovelace_geocomputation_2019]
- Introduction to data science with R (available free [online](http://r4ds.had.co.nz/)) [@grolemund_data_2016]
...
- Academic paper describing the development of a web application for the Department for Transport [@goodman_scenarios_2019]
...
The coursework is a 'portfolio' of work the showcases some key skills and techniques that you have learned or mastered during the module.
