...
- Working alone - running the code in Sections 12.1 to 12.4 the Transport chapter of Geocomputation with R - 30 minutes
...
1. Subset (filter) the data to only include OD pairs in which people walk
...
```{r, echo=FALSE}
# Todo: add code that answers the questions above
```
