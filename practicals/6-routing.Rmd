...
piggyback::pb_download("otp_TDS.zip", tag = "0.20.1")
unzip("otp_TDS.zip")
# https://github.com/ITSLeeds/TDS/releases/download/0.20.1/otp_TDS.zip
```

<!-- Note: for advanced users you can set-up routing locally with the following commands: -->

```{r, eval=FALSE, echo=FALSE}
otp_dl_jar(path = "~/programs/", version = "2.1.0")
```
...
# java --version
java -version
# java -Xmx10000M -d64 -jar "/home/" --router west-yorkshire --graphs "/home/robin/programs/otp1.5/otp_TDS/graphs" --server --port 8080 --securePort 8081
java -Xmx10000M -jar "/home/rlatemin/R/x86_64-pc-linux-gnu-library/4.2/opentripplanner/jar/otp-2.1.0-shaded.jar" --router west-yorkshire --graphs "/home/rlatemin/github/itsleeds/TDS/otp_TDS/graphs" --server --port 8080 --securePort 8081
# ip = "xx.x.218.83" 
```
...
otp_setup(
  ...
  dir = "/home/rlatemin/github/itsleeds/TDS/otp_TDS", 
