...
1. Describe how you obtained and cleaned data
...
2. Describe how you stored and transported data, including appropriate file formats

    **Application choice and impact**

1. Choice of topic that has interesting datasets and important real world applications
1. Appropriate use of methods for the choice of application, building on previous work
1. Explain the potential impacts of the work and originality
...
1. Provide evidence of project planning, e.g. how work was divided, scheduled, and managed.
