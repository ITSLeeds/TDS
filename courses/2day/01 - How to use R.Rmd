---
title: "How to use R/RStudio effectively"
...
1. Highlight a block of code or part of a line of code and press `CTRL + Enter` to run the highligted code.
...
1. Type the name of object into the console e.g. `cat`, what happens if we try to view all 2000 even_numbers?
1. Use the `head()` function to view the first few values e.g. `head(even_numbers)`
1. Use the view table button next to matrix or data.frame objects in the envrionment tab.
